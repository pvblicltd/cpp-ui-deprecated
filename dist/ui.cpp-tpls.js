 ...
 * Version: 0.0.1 - 2015-06-10
 * License: 
 */
angular.module("ui.cpp", ["ui.cpp.tpls", "ui.cpp.demo-module","ui.cpp.global-nav","ui.cpp.global-search","ui.cpp.james-test","ui.cpp.showing-module"]);
angular.module("ui.cpp.tpls", ["demo-module/demo-module.html","global-nav/global-nav.html","global-search/global-search.html","james-test/james-test.html","showing-module/showing-module.html"]);

angular.module("demo-module/demo-module.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("demo-module/demo-module.html",
    "<div class=\"demoModule\">\n" +
    "\n" +
    "</div>\n" +
    "");
}]);
...
angular.module("global-search/global-search.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("global-search/global-search.html",
...
angular.module("james-test/james-test.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("james-test/james-test.html",
    "<div class=\"jamesTest\">\n" +
    "\n" +
    "</div>\n" +
    "");
...
angular.module("showing-module/showing-module.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("showing-module/showing-module.html",
    "<div class=\"showingModule\">\n" +
    "\n" +
    "</div>\n" +
    "");
}]);
